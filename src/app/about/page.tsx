      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            <p>
              In high school, I was never a good student until I realised they won&apos;t let me take the Computer
              Science class unless I started getting better grades.
            </p>
            <p>
              I spent a good portion of my early career (pre-university) in computer security, because I served a
              cybersecurity unit during my conscription in the Singapore army. I found security vulnerabilities in
              software, and worked with relevant organisations to fix them. Examples include the{' '}
              <Link href="https://english.ncsc.nl/" className="font-semibold text-teal-500">
                Dutch National Cyber Security Centre
              </Link>
              , Singapore&apos;s{' '}
              <Link href="https://www.mindef.gov.sg/" className="font-semibold text-teal-500">
                Ministry of Defense
              </Link>
              , Singapore&apos;s{' '}
              <Link href="https://www.tech.gov.sg/" className="font-semibold text-teal-500">
                Government Technology Agency
              </Link>
              ,{' '}
              <Link href="https://sg.yahoo.com/" className="font-semibold text-teal-500">
                Yahoo!
              </Link>
              , and the maintainers of{' '}
              <Link href="https://nodejs.org/en" className="font-semibold text-teal-500">
                Node.js
              </Link>
              . This got me invited to three private time-bound bug bounty events hosted by the government, each of
              which I ranked 🥇 1st in impact among global participants.
            </p>
            <p>
              ...
              and{' '}
              <Link href="https://xsleaks.dev/" className="font-semibold text-teal-500">
                XS-Leaks
              </Link>
              . Among other things, this earned me 15 credits in the CVE vulnerability database, and speaking
              engagements at conferences in the U.K. and Singapore.
            </p>
            <p>
              I also competed in Capture The Flag (CTF) competitions with{' '}
              <Link href="https://ctftime.org/team/205897/" className="font-semibold text-teal-500">
                Blue Water
              </Link>
              , and placed 🥈 2nd in the{' '}
              <Link href="https://defcon.org/" className="font-semibold text-teal-500">
                DEF CON
              </Link>{' '}
            ...
            <p>
              ...
              and{' '}
              <Link href="https://www.tiktok.com/about" className="font-semibold text-teal-500">
                TikTok
              </Link>
            ...
            <p>
              ...
              possible. I&apos;m at my best when I work on meaningful problems that serve a clear purpose in the world.
            </p>
          </div>
        </div>
        <div className="lg:pl-20">
          ...
          <ul className="mt-8">
            {notEmail.map(({ href, description, icon: Icon }, index) => (
              <SocialLink key={index} href={href} icon={Icon} className={index > 0 ? 'mt-4' : undefined}>
                {description}
              </SocialLink>
            ))}
            {email && (
